...
class Agent {
  ...
  constructor(API_ROOT = "/") {
    ...
    this.axios.interceptors.request.use(async function(config) {
      const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyIiwiaWQiOiI2MDM0NmVhMDM3MmEzNTBjNTllZDk3YWMiLCJleHAiOjE2MTcwNzE0NDUsImlhdCI6MTYxNDQ4MzA0NX0.pcdbThGTWZPZYZJFVPdDj_q0rSpd9xV6RR3GebM2wms' // await Agent.getToken();
